...
/// Lesson 1: CSS Validation & Scoping
    ...
    html! {
        ...
        <html>
            <head>
                ...
                <title>"Lesson 1: CSS Validation - Azumi"</title>
            ...
            <body>
                <div class="lesson-container">
                    ...
                    <nav class="nav-buttons">
                        <a href="/lesson-0" class="btn btn-secondary">"← Previous: Quoting"</a>
                        <a href="/lesson-2" class="btn">"Next: Global Styles →"</a>
                    </nav>
                </div>
            </body>
        </html>
